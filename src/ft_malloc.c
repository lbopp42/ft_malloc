...
/*   Updated: 2019/01/16 17:11:00 by lbopp            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	*malloc(size_t size)
{
	...
	if (DEBUG == 1)
	{
	    ...
	    data_tmp = (t_meta*)((char*)ptr - sizeof(t_meta));
	    ft_putendl_fd("============= AFTER MALLOC =========================", 3);
    ...
    {
	    ft_putendl_fd("============== MALLOC ========================", 3);
	    print_mem_fd((char*)data + sizeof(t_meta), 3);
	    ft_putchar_fd('\n', 3);
	    print_mem_fd((char*)data->prev + sizeof(t_meta), 3);
	    ft_putchar_fd('\n', 3);
	    ft_putnbr_fd(size, 3);
	    ft_putchar_fd('\n', 3);
	    show_alloc_mem_fd(3);
